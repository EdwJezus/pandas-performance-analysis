...
Análise exploratória de dados sobre o desempenho de alunos
em uma turma fictícia, com foco em identificar padrões entre 
frequência, notas e resultado final.
...
jupyter notebook notebooks/analyse_alunos.ipynb
```
